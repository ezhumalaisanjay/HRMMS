...
export default function ProfileSettings({userDetails} : {userDetails: UserDetails[] | null}) {
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      employeeID: userDetails && userDetails[0]?.employeeID || "",
      nickName: userDetails && userDetails[0]?.nickName || "",
      ...
      division: userDetails && userDetails[0]?.division || "",
      department: userDetails && userDetails[0]?.department || "",
      location: userDetails && userDetails[0]?.location || "",
      designation: userDetails && userDetails[0]?.designation || "",
      role: userDetails && userDetails[0]?.role || "",
      doj: userDetails && userDetails[0]?.doj ? new Date(userDetails[0]?.doj) : undefined,
      employmentType: userDetails && userDetails[0]?.employmentType || "",
      dob: userDetails && userDetails[0]?.dob ? new Date(userDetails[0]?.dob) : undefined,
      employeeStatus: userDetails && userDetails[0]?.employeeStatus || "",
      source: userDetails && userDetails[0]?.source || "",
      experience: userDetails && userDetails[0]?.experience || "",
      maritalStatus: userDetails && userDetails[0]?.maritalStatus || "",
      about: userDetails && userDetails[0]?.about || "",
      gender: userDetails && userDetails[0]?.gender || "",
      expertise: userDetails && userDetails[0]?.expertise || "",
    },
  });
      ...
      <main className="flex-1 p-8 shadow-md rounded-lg gap-3">
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-3">
            ...
            <Button type="submit" >
              {isSubmitLoading ? <><Loader className="animate-spin" /> Submitting... </> : "Submit"}
            </Button>
          </form>
        </Form>
      </main>
